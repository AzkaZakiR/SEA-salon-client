...
import registerBg from "../images/loginbg.png";
...
const Register = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (validateInputs()) {
            try {
                const response = await axios.post(`${baseurl}/api/v1/auth/register`, registerData);
            ...
            <div className="w-full md:w-1/2 flex items-center justify-center bg-slate-800 md:from-white md:to-white h-screen">
                ...
                >
                    <motion.h1
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        transition={{ duration: 0.75, delay: 0.25 }}
                        className="text-xl font-bold mb-5 leading-tight tracking-tight flex gap-3 text-white md:text-2xl"
                    >
                        <Link
                            to="/home"
                    ...
                    <motion.button
                        ...
                        className={`w-full text-white bg-[#505451] hover:bg-[#3d403e]/90 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center ${loading || isSuccess ? "cursor-not-allowed" : ""
                            }`}
                    >
                    ...
                    <motion.p
                        ...
                        className="text-xs font-light text-white text-center"
                    >
                        Sudah punya akun?{" "}
                        <Link
                            to="/login"
                            className="font-medium text-[#505451] hover:underline"
                        >
                            Masuk di sini
                        </Link>
                    </motion.p>
